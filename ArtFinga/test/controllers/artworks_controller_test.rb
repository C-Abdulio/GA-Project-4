...
class ArtworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post artworks_url, params: { artwork: { resources: @artwork.resources, title: @artwork.title, username: @artwork.username } }, as: :json
    end
  ...
  test "should update artwork" do
    patch artwork_url(@artwork), params: { artwork: { resources: @artwork.resources, title: @artwork.title, username: @artwork.username } }, as: :json
    assert_response 200
  end
